...
*/
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (empty($_POST["name"]) && empty($_POST["email"]) && empty($_POST["message"])) {  // If field is empty
              echo '<div style="text-align: center;"><h1 style="font-weight:300;font-size:2rem;">Sorry, all fields are required. Please go back and retry.</h1></div>';
            } else {
              ...
              if (!filter_var($mailFrom, FILTER_VALIDATE_EMAIL)) {
                ...
                echo  '<div style="text-align: center;"><h1 style="font-size:2rem;">Invalid email format</h1><br><br></div>';
        ...
        $mailTo = "test@angusclark.me"; //  Even gmail works!
        ...
        echo '<div style="text-align: center;"><h1 style="font-weight:300;font-size:2rem;"> Thanks for the inquiry. I\'ll get back to you soon :) </h1></div>';
